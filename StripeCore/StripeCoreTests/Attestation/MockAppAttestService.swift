...
class MockAppAttestService: AppAttestService {
    ...
    var shouldFailKeygenWithError: Error? = nil
    var shouldFailAssertionWithError: Error? = nil
    var shouldFailAttestationWithError: Error? = nil
...
@_spi(STP) public class MockAttestBackend: StripeAttestBackend {
    var storedChallenge: String? = nil
