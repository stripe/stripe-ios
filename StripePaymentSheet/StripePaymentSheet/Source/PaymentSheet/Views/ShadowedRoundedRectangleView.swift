...
class ShadowedRoundedRectangle: UIView, SelectableRectangle {
    ...
    private func update() {
        ...
        // Corner radius
        roundedRectangle.layer.cornerRadius = appearance.cornerRadius ?? appearance.defaultCornerRadius
        layer.cornerRadius = appearance.cornerRadius ?? appearance.defaultCornerRadius
