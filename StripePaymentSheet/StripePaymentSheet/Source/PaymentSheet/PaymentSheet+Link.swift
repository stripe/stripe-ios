...
extension PaymentSheet {
    ...
    func presentPayWithNativeLinkController(
        ...
        payWithNativeLink.presentAsBottomSheet(from: presentingController, shouldOfferApplePay: shouldOfferApplePay, shouldFinishOnClose: shouldFinishOnClose, completion: { result, confirmationType, didFinish in
