//
//  CustomerSheet+PaymentOption.swift
//  StripePaymentsUI
//
...
@_spi(PrivateBetaCustomerSheet) extension CustomerSheet {
    ...
    @_spi(PrivateBetaCustomerSheet) public enum PaymentOption: Equatable {
        ...
        @_spi(STP) public static func setDefaultPaymentMethod(_ paymentMethodOption: CustomerSheet.PaymentOption?, forCustomer customerID: String?) {
        ...
        @_spi(STP) public static func defaultPaymentMethod(for customerID: String?) -> CustomerSheet.PaymentOption? {
            let key = customerID ?? ""
            ...
            return CustomerSheet.PaymentOption(value: value)
        }
    }
}
