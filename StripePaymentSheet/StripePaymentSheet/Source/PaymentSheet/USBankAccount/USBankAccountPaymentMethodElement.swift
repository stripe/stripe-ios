...
final class USBankAccountPaymentMethodElement: Element {
    ...
    private let addressElement: PaymentMethodElement?
    ...
    var name: String? {
        return self.formElement.updateParams(params: IntentConfirmParams(type: .USBankAccount))?.paymentMethodParams
            .nonnil_billingDetails.name
    }

    var email: String? {
        return self.formElement.updateParams(params: IntentConfirmParams(type: .USBankAccount))?.paymentMethodParams
            .nonnil_billingDetails.email
    }
    ...
    init(
        ...
        self.addressElement = addressElement
    ...
    class func attributedMandateText(
        ...
        var mandateText =
            isSaving ? String(format: Self.SaveAccountMandateText, merchantName) : Self.ContinueMandateText
