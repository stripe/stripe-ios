...
extension PaymentSheet {
    ...
    static fileprivate func confirmAfterHandlingLocalActions(
        ...
        case .link(let confirmOption):
            ...
            case .withPaymentDetails(let linkAccount, let paymentDetails, let billingPhoneNumber):
                ...
                if elementsSession.linkPassthroughModeEnabled {
                    ...
                    confirmWithPaymentDetails(linkAccount, paymentDetails, paymentDetails.cvc, billingPhoneNumber, shouldSave)
                }
            }
