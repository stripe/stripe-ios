...
public extension PaymentSheet {
    ...
    struct IntentConfiguration {
        ...
        public enum SetupFutureUsage: String {
            ...
            @_spi(PaymentMethodOptionsSetupFutureUsagePrivatePreview) case none = "none"
        }
        ...
        public enum Mode {
            ...
            public struct PaymentMethodOptions {
                ...
                @_spi(PaymentMethodOptionsSetupFutureUsagePrivatePreview) public init(setupFutureUsageValues: [STPPaymentMethodType: SetupFutureUsage]? = nil) {
