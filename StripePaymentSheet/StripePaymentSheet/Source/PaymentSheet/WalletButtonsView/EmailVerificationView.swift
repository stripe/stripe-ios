...
struct EmailVerificationView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            .padding()
            .background(Color(uiColor: .linkHeaderBackground))
            .frame(height: 56)
        ...
        .clipShape(RoundedRectangle(cornerRadius: WalletButtonsView.cornerRadius))
        .overlay(
            RoundedRectangle(cornerRadius: WalletButtonsView.cornerRadius)
