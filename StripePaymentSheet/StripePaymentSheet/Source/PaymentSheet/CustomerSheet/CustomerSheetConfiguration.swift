...
extension CustomerSheet {
    ...
    public struct Configuration {
        ...
        /// By default, CustomerSheet will accept all card funding types supported by Stripe.
        /// You can specify which card funding types CustomerSheet should block or allow by providing an array of those funding types.
