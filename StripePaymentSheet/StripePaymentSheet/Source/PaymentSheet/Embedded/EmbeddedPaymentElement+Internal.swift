...
extension EmbeddedPaymentElement {
    ...
    func makeFormViewControllerIfNecessary(selection: RowButtonType?) -> EmbeddedFormViewController? {
...
extension EmbeddedPaymentElement: EmbeddedPaymentMethodsViewDelegate {
    ...
    func embeddedPaymentMethodsViewDidUpdateSelection() {
        ...
        self.selectedFormViewController = makeFormViewControllerIfNecessary(selection: embeddedPaymentMethodsView.selectedRowButton?.type)
