...
@_spi(STP) extension STPPaymentMethodType {
    ...
    static var requiresMandateDataForPaymentIntent: Set<STPPaymentMethodType> {
        [.momo, .gcash, .ngCard, .touchNGo, .trueMoney, .goPay, .alipay, .payPal, .cashApp, .revolutPay, .amazonPay, .klarna, .satispay, .twint, .kakaoPay, .naverPay, .krCard]
    }
    ...
    static var requiresMandateDataForSetupIntent: Set<STPPaymentMethodType> {
        [.momo, .gcash, .ngCard, .touchNGo, .trueMoney, .goPay, .alipay, .payPal, .revolutPay, .satispay, .twint, .kakaoPay, .naverPay, .krCard]
    }
}
