...
extension AddressViewController {
    ...
    private func loadUI() {
        ...
        stackView.directionalLayoutMargins = .insets(top: configuration.appearance.formInsets.top, leading: configuration.appearance.formInsets.left, trailing: configuration.appearance.formInsets.right)
