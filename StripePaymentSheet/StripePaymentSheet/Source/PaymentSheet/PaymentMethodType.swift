...
extension PaymentSheet {
    enum PaymentMethodType: Equatable, Hashable {
        ...
        func makeImage(forDarkBackground: Bool = false, currency: String? = nil, iconStyle: PaymentSheet.Appearance.IconStyle, updateHandler: DownloadManager.UpdateImageHandler?) -> UIImage {
