...
extension PaymentSheet {
    enum PaymentMethodType: Equatable, Hashable {
        ...
        static func supportsInstantBankPayments(
            ...
            guard elementsSession.orderedPaymentMethodTypes.contains(.link), configuration.link.shouldDisplay, configuration.link.canDisplayBankTab else {
                return .notSupported
            }
        ...
        static func supportsLinkCardIntegration(
            ...
            guard elementsSession.isLinkCardBrand, configuration.link.shouldDisplay, configuration.link.canDisplayBankTab else {
                return .notSupported
            }
