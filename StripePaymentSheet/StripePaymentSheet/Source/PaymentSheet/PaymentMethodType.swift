        ...
        static func supportsAdding(
            ...
            if intent.isSetupFutureUsageSet(for: paymentMethod) {
                requirements = {
                    ...
                    case .card:
                        return []
                    case .payPal, .cashApp, .revolutPay, .amazonPay, .klarna, .satispay, .payPay:
                        return [.returnURL]
