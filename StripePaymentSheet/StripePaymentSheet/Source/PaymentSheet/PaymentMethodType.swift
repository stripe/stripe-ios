        ...
        static func supportsAdding(
            ...
            if intent.isSetupFutureUsageSet(for: paymentMethod) {
                requirements = {
                    ...
                    case .card:
                        return []
                    case .alipay, .payPal, .cashApp, .revolutPay, .amazonPay, .klarna, .satispay, .twint, .naverPay:
                        return [.returnURL]
                ...
                requirements = {
                    ...
                    case .alipay, .EPS, .FPX, .grabPay, .netBanking, .payPal, .przelewy24, .klarna,
                            ...
                            .wero, .payByBank, .naverPay, .payco, .sequra:
                        return [.returnURL]
                    case .USBankAccount:
                        return [
                    ...
                    case .bacsDebit:
                        return [.returnURL, .userSupportsDelayedPaymentMethods]
                    case .kakaoPay, .link, .krCard, .unknown:
                        return [.unsupported]
                    @unknown default:
                        return [.unsupported]
                    }
