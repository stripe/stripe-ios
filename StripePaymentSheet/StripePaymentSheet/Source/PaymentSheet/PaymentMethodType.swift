        ...
        static func supportsAdding(
            ...
            if intent.isSetupFutureUsageSet(for: paymentMethod) {
                requirements = {
                    ...
                    case .card:
                        return []
                    case .momo, .gcash, .ngCard, .touchNGo, .trueMoney, .goPay, .alipay, .payPal, .cashApp, .revolutPay, .amazonPay, .klarna, .satispay, .twint, .kakaoPay, .naverPay, .krCard:
                        return [.returnURL]
                    ...
                    case .bacsDebit:
                        return [.returnURL, .userSupportsDelayedPaymentMethods]
                    case .shopeePay, .qris, .ngBankTransfer, .ngWallet, .ngUSSD, .mondu, .cardPresent, .blik, .weChatPay, .grabPay, .FPX, .przelewy24, .EPS,
                ...
                requirements = {
                    ...
                    case .blik, .card, .cardPresent, .weChatPay, .paynow, .promptPay, .mbWay, .bizum:
                        return []
                    case .momo, .gcash, .shopeePay, .qris, .ngCard, .ngBankTransfer, .touchNGo, .trueMoney, .ngWallet, .ngUSSD, .mondu, .goPay, .alipay, .EPS, .FPX, .grabPay, .netBanking, .payPal, .przelewy24, .klarna,
