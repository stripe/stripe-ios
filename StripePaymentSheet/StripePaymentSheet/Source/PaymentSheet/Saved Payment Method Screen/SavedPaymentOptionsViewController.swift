...
class SavedPaymentOptionsViewController: UIViewController {
    ...
    private func updateUI() {
        let defaultPaymentMethod = CustomerSheet.PaymentOption.defaultPaymentMethod(for: configuration.customerID)
    ...
    func selectLink() {
        ...
        CustomerSheet.PaymentOption.setDefaultPaymentMethod(.link, forCustomer: configuration.customerID)
    ...
    UICollectionViewDelegateFlowLayout
{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case .add:
            ...
            assertionFailure()
        case .applePay:
            CustomerSheet.PaymentOption.setDefaultPaymentMethod(.applePay, forCustomer: configuration.customerID)
        case .link:
            CustomerSheet.PaymentOption.setDefaultPaymentMethod(.link, forCustomer: configuration.customerID)
        case .saved(let paymentMethod):
            CustomerSheet.PaymentOption.setDefaultPaymentMethod(
