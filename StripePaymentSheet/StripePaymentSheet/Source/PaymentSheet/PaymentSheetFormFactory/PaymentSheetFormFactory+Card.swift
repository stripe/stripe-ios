...
extension PaymentSheetFormFactory {
    ...
    func makeCard(linkAppearance: LinkAppearance? = nil) -> PaymentMethodElement {
        ...
        let billingAddressSection: PaymentMethodElementWrapper<AddressSectionElement>? = {
            ...
            case .full:
                return makeBillingAddressSection(fieldsToCollect: .all(autocomplete: .compact()), countries: countries, includeEmail: shouldIncludeEmail, includePhone: shouldIncludePhone)
            case .never:
                return nil
            }
        }()
