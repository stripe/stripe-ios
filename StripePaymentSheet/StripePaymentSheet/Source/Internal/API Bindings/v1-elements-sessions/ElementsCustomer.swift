...
private extension STPPaymentMethod {
    ...
    func setLinkPaymentDetails(from paymentDetails: ConsumerPaymentDetails) {
        ...
        case .card(let cardDetails):
            let linkCardDetails = LinkPaymentDetails.Card(from: cardDetails, nickname: paymentDetails.nickname, id: paymentDetails.stripeID)
            self.linkPaymentDetails = .card(linkCardDetails)
        case .bankAccount(let bankDetails):
            let bankAccount = LinkPaymentDetails.BankDetails(from: bankDetails, id: paymentDetails.stripeID)
...
private extension LinkPaymentDetails.BankDetails {
    init(from bankDetails: ConsumerPaymentDetails.Details.BankAccount, id: String) {
        self = .init(
            id: id,
...
private extension LinkPaymentDetails.Card {
    init(from cardDetails: ConsumerPaymentDetails.Details.Card, nickname: String?, id: String) {
        self = .init(
            id: id,
