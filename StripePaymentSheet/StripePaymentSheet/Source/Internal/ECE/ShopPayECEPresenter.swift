...
class ShopPayECEPresenter: NSObject, UIAdaptivePresentationControllerDelegate {
    ...
    func present(from viewController: UIViewController,
        ...
        eceVC.view.layer.cornerRadius = self.flowController.configuration.appearance.cornerRadius ?? self.flowController.configuration.appearance.defaultCornerRadius
