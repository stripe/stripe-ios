...
extension PayWithLinkViewController {
    ...
    final class UpdatePaymentViewController: BaseViewController {
        ...
        init(
            ...
            super.init(
                context: context,
                navigationTitle: "Some super long title on this page bla bla bla"
//                navigationTitle: isBillingDetailsUpdateFlow ? .Localized.confirm_payment_details : .Localized.update_card
            )
        }
