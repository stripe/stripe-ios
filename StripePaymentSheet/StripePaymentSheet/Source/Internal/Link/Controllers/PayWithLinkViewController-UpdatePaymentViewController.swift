...
protocol UpdatePaymentViewControllerDelegate: AnyObject {
    func didUpdate(paymentMethod: ConsumerPaymentDetails, shouldConfirm: Bool, billingPhoneNumber: String?)
}
...
extension PayWithLinkViewController {
    ...
    final class UpdatePaymentViewController: BaseViewController {
        ...
        private lazy var titleLabel: UILabel = {
            ...
            label.text = isBillingDetailsUpdateFlow ? "Update before continuing" : String.Localized.update_card
            return label
        }()
                ...
                case .success(let updatedPaymentDetails):
                    ...
                    self.updateButton.update(state: .succeeded, style: nil, callToAction: nil, animated: true) {
                        self.delegate?.didUpdate(
                            ...
                            shouldConfirm: self.isBillingDetailsUpdateFlow,
                            billingPhoneNumber: self.isBillingDetailsUpdateFlow ? params.billingDetails.phone : nil
                        )
