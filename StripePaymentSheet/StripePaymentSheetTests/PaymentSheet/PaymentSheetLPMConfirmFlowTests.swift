...
final class PaymentSheet_LPM_ConfirmFlowTests: STPNetworkStubbingTestCase {
    ...
    func testAffirmConfirmFlows() async throws {
        try await _testConfirm(intentKinds: [.paymentIntent], currency: "USD", paymentMethodType: .affirm, merchantCountry: .US,
                               expectedHierarchy: ExpectedFormHierarchy.Affirm.paymentIntent) { _ in }
    }
