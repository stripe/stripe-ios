...
class FlowControllerStateTests: XCTestCase {
    ...
    func testAddPaymentMethodViewControllerDelegate() {
        ...
        _ = AddPaymentMethodViewController(intent: intent, elementsSession: .emptyElementsSession, configuration: config, isLinkEnabled: true, formCache: .init(), delegate: apmvcDelegate)
