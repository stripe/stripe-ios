...
final class VerticalPaymentMethodListViewControllerTest: XCTestCase {
    ...
    func testSelectionHash_savedPaymentMethod() {
        let selection = RowButtonType.saved(paymentMethod: ._testCard())
        let selection1 = RowButtonType.saved(paymentMethod: ._testCard())
    ...
    func testSelectionHash_differentSavedPaymentMethod() {
        let selection = RowButtonType.saved(paymentMethod: ._testCard())
        let selection1 = RowButtonType.saved(paymentMethod: ._testSEPA())
    ...
    func testSelectionHash_savedPaymentMethod_sameInstance() {
        ...
        let selection = RowButtonType.saved(paymentMethod: testCard)
        let selection1 = RowButtonType.saved(paymentMethod: testCard)
    ...
    func testSelectionHash_newPaymentMethod_sameType() {
        ...
        let selection1 = RowButtonType.new(paymentMethodType: paymentMethodType)
    ...
    func testSelectionHash_newPaymentMethod_differentType() {
        let selection = RowButtonType.new(paymentMethodType: .stripe(.card))
        let selection1 = RowButtonType.new(paymentMethodType: .stripe(.iDEAL))
    ...
    func testSelectionHash_applePay() {
        ...
        let selection1 = RowButtonType.applePay
    ...
    func testSelectionHash_link() {
        ...
        let selection1 = RowButtonType.link
    ...
    func testSelectionHash_applePay_and_link_different() {
        let applePaySelection = RowButtonType.applePay
        let linkSelection = RowButtonType.link
    ...
    func testSelectionHash_applePay_and_new_different() {
        let applePaySelection = RowButtonType.applePay
        let newSelection = RowButtonType.new(paymentMethodType: .stripe(.iDEAL))
    ...
    func testSelectionHash_applePay_and_saved_different() {
        let applePaySelection = RowButtonType.applePay
        let savedSelection = RowButtonType.saved(paymentMethod: ._testCard())
