...
class CardFundingFilterTests: XCTestCase {
    ...
    func testIsAccepted_allFundingTypesAccepted() {
        ...
        let filter = DefaultCardFundingFilter()
    ...
    func testIsAccepted_allowedFundingTypes_debitOnly() {
        let filter = PaymentSheetCardFundingFilter(allowedFundingTypes: .debit, filteringEnabled: true)
    ...
    func testIsAccepted_allowedFundingTypes_creditOnly() {
        let filter = PaymentSheetCardFundingFilter(allowedFundingTypes: .credit, filteringEnabled: true)
    ...
    func testIsAccepted_allowedFundingTypes_prepaidOnly() {
        let filter = PaymentSheetCardFundingFilter(allowedFundingTypes: .prepaid, filteringEnabled: true)
    ...
    func testIsAccepted_allowedFundingTypes_unknownOnly() {
        let filter = PaymentSheetCardFundingFilter(allowedFundingTypes: .unknown, filteringEnabled: true)
    ...
    func testIsAccepted_allowedFundingTypes_debitAndCredit() {
        let filter = PaymentSheetCardFundingFilter(allowedFundingTypes: [.debit, .credit], filteringEnabled: true)
    ...
    func testIsAccepted_allFundingTypesAllowed() {
        let filter = PaymentSheetCardFundingFilter(allowedFundingTypes: [.debit, .credit, .prepaid, .unknown], filteringEnabled: true)
    ...
    func testIsAccepted_otherFundingType_permissivelyAccepted() {
        ...
        let restrictiveFilters: [any CardFundingFilter] = [
            PaymentSheetCardFundingFilter(allowedFundingTypes: .debit, filteringEnabled: true),
            PaymentSheetCardFundingFilter(allowedFundingTypes: .credit, filteringEnabled: true),
            PaymentSheetCardFundingFilter(allowedFundingTypes: .prepaid, filteringEnabled: true),
            PaymentSheetCardFundingFilter(allowedFundingTypes: [.debit, .credit], filteringEnabled: true),
        ]
    ...
    func testIsAccepted_filteringDisabled_acceptsAll() {
        ...
        let filter = PaymentSheetCardFundingFilter(allowedFundingTypes: .debit, filteringEnabled: false)
    ...
    func testFromElementsSession_filteringEnabled() {
        ...
        let filter = PaymentSheetCardFundingFilter.from(allowedFundingTypes: .debit, elementsSession: elementsSession)
    ...
    func testAllowedFundingTypesDisplayString_debitAndPrepaid() {
        let filter = PaymentSheetCardFundingFilter(allowedFundingTypes: [.debit, .prepaid], filteringEnabled: true)
    ...
    func testAllowedFundingTypesDisplayString_creditAndPrepaid() {
        let filter = PaymentSheetCardFundingFilter(allowedFundingTypes: [.credit, .prepaid], filteringEnabled: true)
    ...
    func testAllowedFundingTypesDisplayString_allThreeTypes() {
        ...
        let filter = PaymentSheetCardFundingFilter(allowedFundingTypes: [.debit, .credit, .prepaid], filteringEnabled: true)
        XCTAssertNil(filter.allowedFundingTypesDisplayString())
    }
