...
class CardFundingFilterTests: XCTestCase {
    ...
    func testIsAccepted_allowedFundingTypes_debitOnly() {
        let allowedFundingTypes: [PaymentSheet.CardFundingCategory] = [.debit]
    ...
    func testIsAccepted_allowedFundingTypes_creditOnly() {
        let allowedFundingTypes: [PaymentSheet.CardFundingCategory] = [.credit]
        let filter = CardFundingFilter(cardFundingAcceptance: .allowed(fundingTypes: allowedFundingTypes))
    ...
    func testIsAccepted_allowedFundingTypes_prepaidOnly() {
        let allowedFundingTypes: [PaymentSheet.CardFundingCategory] = [.prepaid]
        let filter = CardFundingFilter(cardFundingAcceptance: .allowed(fundingTypes: allowedFundingTypes))
    ...
    func testIsAccepted_allowedFundingTypes_unknownOnly() {
        let allowedFundingTypes: [PaymentSheet.CardFundingCategory] = [.unknown]
        let filter = CardFundingFilter(cardFundingAcceptance: .allowed(fundingTypes: allowedFundingTypes))
    ...
    func testIsAccepted_allowedFundingTypes_debitAndCredit() {
        let allowedFundingTypes: [PaymentSheet.CardFundingCategory] = [.debit, .credit]
        let filter = CardFundingFilter(cardFundingAcceptance: .allowed(fundingTypes: allowedFundingTypes))
    ...
    func testIsAccepted_allFundingTypesAllowed() {
        let allowedFundingTypes: [PaymentSheet.CardFundingCategory] = [.debit, .credit, .prepaid, .unknown]
        let filter = CardFundingFilter(cardFundingAcceptance: .allowed(fundingTypes: allowedFundingTypes))
    ...
    // MARK: - STPPaymentMethodCard.isAccepted Tests

    func testPaymentMethodCard_isAccepted_allFilters() {
        ...
        let brandFilter = CardBrandFilter(cardBrandAcceptance: .all)
        let fundingFilter = CardFundingFilter(cardFundingAcceptance: .all)

        XCTAssertTrue(card.isAccepted(cardBrandFilter: brandFilter, cardFundingFilter: fundingFilter))
    }

    func testPaymentMethodCard_isAccepted_brandBlocked() {
        let card = STPPaymentMethodCard.decodedObject(fromAPIResponse: [
            "brand": "visa",
            "last4": "4242",
            "exp_month": 12,
        ...
        let brandFilter = CardBrandFilter(cardBrandAcceptance: .disallowed(brands: [.visa]))
        let fundingFilter = CardFundingFilter(cardFundingAcceptance: .all)

        XCTAssertFalse(card.isAccepted(cardBrandFilter: brandFilter, cardFundingFilter: fundingFilter))
    }

    func testPaymentMethodCard_isAccepted_fundingBlocked() {
        let card = STPPaymentMethodCard.decodedObject(fromAPIResponse: [
            "brand": "visa",
            "last4": "4242",
            "exp_month": 12,
        ...
        let brandFilter = CardBrandFilter(cardBrandAcceptance: .all)
        let fundingFilter = CardFundingFilter(cardFundingAcceptance: .allowed(fundingTypes: [.debit]))

        XCTAssertFalse(card.isAccepted(cardBrandFilter: brandFilter, cardFundingFilter: fundingFilter))
    }

    func testPaymentMethodCard_isAccepted_fundingAllowed() {
        let card = STPPaymentMethodCard.decodedObject(fromAPIResponse: [
            "brand": "visa",
            "last4": "4242",
            "exp_month": 12,
    ...
    func testPaymentMethodCard_isAccepted_noFundingInfo() {
        // Cards without funding info should pass the funding filter
        let card = STPPaymentMethodCard.decodedObject(fromAPIResponse: [
            "brand": "visa",
            "last4": "4242",
            "exp_month": 12,
    ...
    func testPaymentMethodCard_isAccepted_prepaidBlocked() {
        let card = STPPaymentMethodCard.decodedObject(fromAPIResponse: [
            "brand": "visa",
            "last4": "4242",
            "exp_month": 12,
        ...
        let brandFilter = CardBrandFilter(cardBrandAcceptance: .all)
        let fundingFilter = CardFundingFilter(cardFundingAcceptance: .allowed(fundingTypes: [.debit, .credit]))

        XCTAssertFalse(card.isAccepted(cardBrandFilter: brandFilter, cardFundingFilter: fundingFilter))
    }
}

extension STPCardFundingType: CaseIterable {
