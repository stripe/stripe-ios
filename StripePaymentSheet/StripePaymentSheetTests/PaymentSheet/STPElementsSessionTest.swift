...
class STPElementsSessionTest: XCTestCase {
    ...
    func testMergeCardArt_flatFormat_matchingId() {
        ...
        XCTAssertEqual(pm?.card?.cardArt?.url?.absoluteString, "https://b.stripecdn.com/cardart/assets/abc123")
    ...
    func testMergeCardArt_flatFormat_multiplePaymentMethods() {
        ...
        XCTAssertEqual(pms?[0].card?.cardArt?.url?.absoluteString, "https://b.stripecdn.com/cardart/assets/visa")
        XCTAssertEqual(pms?[1].card?.cardArt?.url?.absoluteString, "https://b.stripecdn.com/cardart/assets/amex")
    }
