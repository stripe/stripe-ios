...
class PaymentSheetFlowControllerTests: XCTestCase {
    ...
    func testPaymentOptionDisplayData_LinkCardBrandLabels() {
        // Create a Link card brand payment option
        ...
        // Test labels for Link card brand
        XCTAssertEqual(displayData.labels.label, "Link")
        XCTAssertEqual(displayData.labels.sublabel, "Link")
    }
