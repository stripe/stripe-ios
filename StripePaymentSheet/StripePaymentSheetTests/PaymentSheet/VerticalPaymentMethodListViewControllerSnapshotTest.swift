...
final class VerticalPaymentMethodListViewControllerSnapshotTest: STPSnapshotTestCase, VerticalPaymentMethodListViewControllerDelegate {
    ...
    func testNoSavedPM_noApplePayLink() {
        let sut = VerticalPaymentMethodListViewController(initialSelection: nil, savedPaymentMethods: [], paymentMethodTypes: paymentMethods.map { .stripe($0) }, shouldShowApplePay: false, shouldShowLink: false, shouldShowShopPay: false, savedPaymentMethodAccessoryType: .edit, overrideHeaderView: nil, appearance: .default.applyingLiquidGlassIfPossible(), currency: "USD", amount: 1099, incentive: nil, delegate: self)
        STPSnapshotVerifyView(sut.view, autoSizingHeightForWidth: 375)
    }

    func testSavedCard_noApplePayLink() {
        let sut = VerticalPaymentMethodListViewController(initialSelection: .saved(paymentMethod: ._testCard()), savedPaymentMethods: [._testCard()], paymentMethodTypes: paymentMethods.map { .stripe($0) }, shouldShowApplePay: false, shouldShowLink: false, shouldShowShopPay: false, savedPaymentMethodAccessoryType: .edit, overrideHeaderView: nil, appearance: .default.applyingLiquidGlassIfPossible(), currency: "USD", amount: 1099, incentive: nil, delegate: self)
        STPSnapshotVerifyView(sut.view, autoSizingHeightForWidth: 375)
    }

    func testSavedCard_ApplePayLink() {
        let sut = VerticalPaymentMethodListViewController(initialSelection: .saved(paymentMethod: ._testCard()), savedPaymentMethods: [._testCard()], paymentMethodTypes: paymentMethods.map { .stripe($0) }, shouldShowApplePay: true, shouldShowLink: true, shouldShowShopPay: false, savedPaymentMethodAccessoryType: .edit, overrideHeaderView: nil, appearance: .default.applyingLiquidGlassIfPossible(), currency: "USD", amount: 1099, incentive: nil, delegate: self)
        STPSnapshotVerifyView(sut.view, autoSizingHeightForWidth: 375)
    }

    func testNoSavedPM_ShopPayOnly() {
        let sut = VerticalPaymentMethodListViewController(initialSelection: nil, savedPaymentMethods: [], paymentMethodTypes: paymentMethods.map { .stripe($0) }, shouldShowApplePay: false, shouldShowLink: false, shouldShowShopPay: true, savedPaymentMethodAccessoryType: .edit, overrideHeaderView: nil, appearance: .default.applyingLiquidGlassIfPossible(), currency: "USD", amount: 1099, incentive: nil, delegate: self)
        STPSnapshotVerifyView(sut.view, autoSizingHeightForWidth: 375)
    }
