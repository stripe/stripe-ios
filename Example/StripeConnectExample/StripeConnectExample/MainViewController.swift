...
extension MainViewController: AccountOnboardingControllerDelegate {
    func accountOnboardingDidRequestDismissalFromUser(_ accountOnboarding: StripeConnect.AccountOnboardingController) {
        let alert = UIAlertController(title: "Are you sure you want to close?", message: "There may be unsaved content.", preferredStyle: .alert)
        alert.addAction(UIAlertAction(title: "Yes", style: .destructive, handler: { _ in
            accountOnboarding.dismiss()
        }))
