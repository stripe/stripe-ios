...
extension PaymentSheet.Appearance: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.embeddedPaymentElement.row.flat.disclosure.color = try container.decode(CodableUIColor.self, forKey: .embeddedFlatChevronColor).uiColor
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(CodableUIColor(color: embeddedPaymentElement.row.flat.disclosure.color), forKey: .embeddedFlatChevronColor)
