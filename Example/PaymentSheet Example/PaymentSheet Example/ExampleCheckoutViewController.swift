...
//                    configuration: configuration)
                ...
                self.linkBankPaymentController = LinkBankPaymentController(paymentIntentClientSecret: paymentIntentClientSecret, returnURL: "payments-example://stripe-redirect", billingDetails: nil)
