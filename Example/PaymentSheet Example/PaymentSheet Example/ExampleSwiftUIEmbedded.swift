...
struct ExampleSwiftUIEmbedded: View {
    @ObservedObject var model = MyEmbeddedBackendModel()
...
class MyEmbeddedBackendModel: ObservableObject {
...
struct ExampleSwiftUIEmbedded_Preview: PreviewProvider {
    static var previews: some View {
        ExampleSwiftUIEmbedded()
    }
}
