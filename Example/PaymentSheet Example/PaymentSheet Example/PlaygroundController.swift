    ...
    var intentConfig: PaymentSheet.IntentConfiguration {
        ...
        case .payment:
            return PaymentSheet.IntentConfiguration(
                mode: .payment(amount: settings.amount.rawValue, currency: settings.currency.rawValue, setupFutureUsage: nil, paymentMethodOptions: settings.paymentMethodOptionsSetupFutureUsage.makePaymentMethodOptions(with: settings.additionalPaymentMethodOptionsSetupFutureUsage)),
        ...
        case .paymentWithSetup:
            return PaymentSheet.IntentConfiguration(
                mode: .payment(amount: settings.amount.rawValue, currency: settings.currency.rawValue, setupFutureUsage: .offSession, paymentMethodOptions: settings.paymentMethodOptionsSetupFutureUsage.makePaymentMethodOptions(with: settings.additionalPaymentMethodOptionsSetupFutureUsage)),
                paymentMethodTypes: paymentMethodTypes,
                paymentMethodConfigurationId: settings.paymentMethodConfigurationId,
                confirmHandler: confirmHandler,
                requireCVCRecollection: settings.requireCVCRecollection == .on
...
extension PlaygroundController {
    ...
    func loadBackend(reinitializeControllers: Bool) {
        ...
        var body = [
            ...
            "payment_method_options_setup_future_usage": settings.paymentMethodOptionsSetupFutureUsage.makeDictionary(with: settings.additionalPaymentMethodOptionsSetupFutureUsage),
