...
class PaymentSheetDefaultSPMUITests: PaymentSheetUITestCase {
    ...
    func testAddNewDefaultHorizontalNavigation_CustomerSession() {
        ...
        // Reload and present, retrying until the backend has propagated the new default PM
        reloadAndPresentUntilDefaultPaymentMethod(app, settings: settings, analyticsLog: { self.analyticsLog })
