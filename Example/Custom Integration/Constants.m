...
NSString *const StripePublishableKey = @"pk_test_vNfjx5fIqtH12V0PiJ5HTZr9"; // TODO: replace nil with your own value
...
NSString *const BackendBaseURL = @"https://stripe-ios-example-backend.herokuapp.com"; // TODO: replace nil with your own value
