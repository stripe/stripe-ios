...
5. Head to [example-ios-backend](https://github.com/stripe/example-ios-backend/tree/v15.1.0) and click "Deploy to Heroku". Provide your Stripe test "Secret key" as the `STRIPE_TEST_SECRET_KEY` environment variable. This key should start with `sk_test`.
