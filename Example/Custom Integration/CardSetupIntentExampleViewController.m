...
- (void)pay {
    ...
    [[ExampleAPIClient sharedClient] createSetupIntentWithPaymentMethod:nil
                                                              returnURL:@"payment-example://stripe-redirect"
                                                             completion:^(MyAPIClientResult status, NSString *clientSecret, NSError *error) {
