//
//  AmazonPayExampleViewController.swift
...
class AmazonPayExampleViewController: UIViewController {
    ...
    lazy var payButton: UIButton = {
        ...
        button.setTitle("Pay with Amazon Pay", for: .normal)
...
// MARK: -
extension AmazonPayExampleViewController {
    @objc func pay() {
        // 1. Create an Amazon Pay PaymentIntent
...
extension AmazonPayExampleViewController: STPAuthenticationContext {
