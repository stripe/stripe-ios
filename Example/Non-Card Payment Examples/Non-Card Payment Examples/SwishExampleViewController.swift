//
//  SwishExampleViewController.swift
...
class SwishExampleViewController: UIViewController {
...
// MARK: -
extension SwishExampleViewController {
    @objc func pay() {
        // 1. Create an Swish PaymentIntent
        MyAPIClient.shared().createPaymentIntent(
            ...
            additionalParameters: "supported_payment_methods=swish&currency=sek")
    }
}

extension SwishExampleViewController: STPAuthenticationContext {
