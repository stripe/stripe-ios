...
@_spi(STP) extension UIView {
    ...
    public func addAndPinSubview(_ view: UIView, directionalLayoutMargins: NSDirectionalEdgeInsets)
    {
    ...
    public func addAndPinSubview(_ view: UIView, insets: NSDirectionalEdgeInsets = .zero) {
        view.translatesAutoresizingMaskIntoConstraints = false
        addSubview(view)
        NSLayoutConstraint.activate([
    ...
    public func addAndPinSubviewToSafeArea(_ view: UIView, insets: NSDirectionalEdgeInsets = .zero)
    {
        view.translatesAutoresizingMaskIntoConstraints = false
        addSubview(view)
        NSLayoutConstraint.activate([
    ...
    public static func animateAlongsideKeyboard(
