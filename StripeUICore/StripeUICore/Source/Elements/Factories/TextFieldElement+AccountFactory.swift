    ...
    public enum Account {
        ...
        struct BSBConfiguration: TextFieldElementConfiguration {
            ...
            public func validate(text: String, isOptional: Bool) -> TextFieldElement.ValidationState
            {
                ...
                return bsbNumber.isComplete
                    ? .valid : .invalid(Account.BSBConfiguration.incompleteError)
            }
        ...
        public static func makeBSB(
            defaultValue: String?,
            theme: ElementsUITheme = .default
        ) -> TextFieldElement {
            return TextFieldElement(
                configuration: BSBConfiguration(defaultValue: defaultValue),
                theme: theme
            )
        }
        ...
        struct AUBECSAccountNumberConfiguration: TextFieldElementConfiguration {
            ...
            public func validate(text: String, isOptional: Bool) -> TextFieldElement.ValidationState
            {
                ...
                return text.count == numberOfDigitsRequired
                    ? .valid : .invalid(AUBECSAccountNumberConfiguration.incompleteError)
            }
        ...
        public static func makeAUBECSAccountNumber(
            defaultValue: String?,
            theme: ElementsUITheme = .default
        ) -> TextFieldElement {
            return TextFieldElement(
                configuration: AUBECSAccountNumberConfiguration(defaultValue: defaultValue),
                theme: theme
            )
        }
    }
