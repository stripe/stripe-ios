...
@_spi(STP) public extension TextFieldElement {
    ...
    enum Account {
        ...
        public static func makeBSB(defaultValue: String?, theme: ElementsAppearance) -> TextFieldElement {
        ...
        public static func makeAUBECSAccountNumber(defaultValue: String?, theme: ElementsAppearance) -> TextFieldElement {
        ...
        public static func makeSortCode(defaultValue: String?, theme: ElementsAppearance) -> TextFieldElement {
        ...
        public static func makeBacsAccountNumber(defaultValue: String?, theme: ElementsAppearance) -> TextFieldElement {
