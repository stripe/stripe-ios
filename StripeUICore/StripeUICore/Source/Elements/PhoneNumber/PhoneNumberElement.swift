...
@_spi(STP) public class PhoneNumberElement: ContainerElement {
    ...
    public lazy var view: UIView = {
        ...
        let hStackView = UIStackView(arrangedSubviews: [
            countryDropdownElement.view, textFieldElement.view,
        ])
        return hStackView
    }()
    ...
    public var phoneNumber: PhoneNumber? {
        return PhoneNumber(
            number: textFieldElement.text,
            countryCode: countryDropdownElement.selectedItem.rawData
        )
    }
    ...
    public init(
        ...
        let defaults = Self.deriveDefaults(
