...
@_spi(STP) public extension PhoneNumber {
    struct Metadata: RegionCodeProvider {
        ...
        public static let allMetadata: [Metadata] = [
            ...
            Metadata(prefix: "+1242", regionCode: "BS", pattern: "(###) ###-####"),
            Metadata(prefix: "+1246", regionCode: "BB", pattern: "(###) ###-####"),
            Metadata(prefix: "+1264", regionCode: "AI", pattern: "(###) ###-####"),
            Metadata(prefix: "+1268", regionCode: "AG", pattern: "(###) ###-####"),
            Metadata(prefix: "+1284", regionCode: "VG", pattern: "(###) ###-####"),
            Metadata(prefix: "+1441", regionCode: "BM", pattern: "(###) ###-####"),
            Metadata(prefix: "+1473", regionCode: "GD", pattern: "(###) ###-####"),
            Metadata(prefix: "+1649", regionCode: "TC", pattern: "(###) ###-####"),
            Metadata(prefix: "+1664", regionCode: "MS", pattern: "(###) ###-####"),
            Metadata(prefix: "+1671", regionCode: "GU", pattern: "(###) ###-####"),
            Metadata(prefix: "+1721", regionCode: "SX", pattern: "(###) ###-####"),
            Metadata(prefix: "+1758", regionCode: "LC", pattern: "(###) ###-####"),
            Metadata(prefix: "+1767", regionCode: "DM", pattern: "(###) ###-####"),
            Metadata(prefix: "+1784", regionCode: "VC", pattern: "(###) ###-####"),
            Metadata(prefix: "+1787", regionCode: "PR", pattern: "(###) ###-####"),
            Metadata(prefix: "+1849", regionCode: "DO", pattern: "(###) ###-####"),
            Metadata(prefix: "+1868", regionCode: "TT", pattern: "(###) ###-####"),
            Metadata(prefix: "+1869", regionCode: "KN", pattern: "(###) ###-####"),
            Metadata(prefix: "+1876", regionCode: "JM", pattern: "(###) ###-####"),
            Metadata(prefix: "+1939", regionCode: "PR", pattern: "(###) ###-####"),
            ...
            Metadata(prefix: "+345", regionCode: "KY", pattern: ""),
