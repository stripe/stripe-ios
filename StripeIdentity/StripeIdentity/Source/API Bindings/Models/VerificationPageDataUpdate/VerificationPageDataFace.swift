...
extension StripeAPI {
    struct VerificationPageDataFace: Encodable, Equatable {
        ...
        let bestExposureIso: FourDecimalFloat?
        /// Camera focal length for the best selfie frame.
        let bestFocalLength: FourDecimalFloat?
