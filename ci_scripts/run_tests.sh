...
# Execute tests on legacy devices (iPhone 6 @ iOS 10.x, iPhone 6 @ iOS 9.x)
...
info "Executing tests on legacy devices (iPhone 6 @ iOS 10.x, iPhone 6 @ iOS 9.x)..."
...
# Execute tests on 32-bit device (iPhone 4s @ iOS 9.x)
# - Skips snapshot tests because they're recorded for the iPhone 6 on the newest iOS version only
# - Not sure why tests STPImageLibraryTest fail on older iOS versions
info "Executing tests on 32-bit device  (iPhone 4s @ iOS 9.x)..."
