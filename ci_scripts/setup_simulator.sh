...
# setup_simulator.sh
# Automatically finds or creates an iPhone 12 mini with iOS 26.4 for testing
...
if [ "$1" = "--help" ] || [ "$1" = "-h" ]; then
    ...
    echo ""
    echo "Automatically finds or creates an iPhone 12 mini with iOS 26.4 for testing."
