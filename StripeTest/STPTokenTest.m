...
{
    NSDictionary *cardDict = @{@"number": @"4242424242424242", @"expMonth": @"12", @"expYear": @"2013", @"cvc": @"123", @"name": @"Smerlock Smolmes", @"addressLine1": @"221A Baker Street", @"addressCity": @"New York", @"addressState": @"NY", @"addressZip": @"12345", @"addressCountry": @"USA", @"object": @"something", @"last4": @"1234", @"type": @"Smastersmard", @"fingerprint": @"Fingolfin", @"country": @"Japan"};
