...
- (void)testInvalidExpMonthForYearSameAsCurrentYear {
    ...
    NSString *expMonth = @"1";
    XCTAssertFalse([card validateExpMonth:&expMonth error:&error],
...
- (void)testValidExpMonthForYearSameAsCurrentYear {
    ...
    card.expYear = [self getCurrentYear];
    NSString *expMonth = @"12";
    XCTAssertTrue([card validateExpMonth:&expMonth error:&error],
...
- (void)testInvalidExpYearForYearSameAsCurrentYear {
    ...
    card.expMonth = 1;
    XCTAssertFalse([card validateExpYear:&expYear error:&error],
