...
class UxModelInput : MLFeatureProvider {
    ...
    convenience init(input1With input1: CGImage) throws {
        let __input1 = try MLFeatureValue(cgImage: input1, pixelsWide: 224, pixelsHigh: 224, pixelFormatType: kCVPixelFormatType_32ARGB, options: nil).imageBufferValue!
        self.init(input1: __input1)
    }


    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    convenience init(input1At input1: URL) throws {
        let __input1 = try MLFeatureValue(imageAt: input1, pixelsWide: 224, pixelsHigh: 224, pixelFormatType: kCVPixelFormatType_32ARGB, options: nil).imageBufferValue!
        self.init(input1: __input1)
    }

    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    func setInput1(with input1: CGImage) throws  {
        self.input1 = try MLFeatureValue(cgImage: input1, pixelsWide: 224, pixelsHigh: 224, pixelFormatType: kCVPixelFormatType_32ARGB, options: nil).imageBufferValue!
    }

    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    func setInput1(with input1: URL) throws  {
        self.input1 = try MLFeatureValue(imageAt: input1, pixelsWide: 224, pixelsHigh: 224, pixelFormatType: kCVPixelFormatType_32ARGB, options: nil).imageBufferValue!
    }
}
...
@_spi(STP) public class UxModel {
    ...
    */
    ...
    class func load(configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<UxModel, Error>) -> Void) {
    ...
    */
    @available(macOS 11.0, iOS 14.0, tvOS 14.0, watchOS 7.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<UxModel, Error>) -> Void) {
