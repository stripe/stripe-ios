...
struct ScannedCardImageData {
    ...
    init(previewLayerImage: CGImage, previewLayerViewfinderRect: CGRect) {
    ...
    init?(
        ...
        guard
            ...
            let previewLayerViewfinderRect = ScannedCardImageData
       ...
       self.init(previewLayerImage: previewLayerImage, previewLayerViewfinderRect: previewLayerViewfinderRect)
    }
}
