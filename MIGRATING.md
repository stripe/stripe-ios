...
- We've removed the `email` and `phone` properties in `STPUserInformation`. You can pre-fill this information by setting the `billingAddress` or `shippingAddress` properties appropriately.
