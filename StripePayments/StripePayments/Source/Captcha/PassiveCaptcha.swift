...
@_spi(STP) public actor PassiveCaptchaChallenge {
    ...
    private func startIfNeeded() {
        ...
        guard let hcaptcha = self.hcaptcha,
              let passiveCaptcha = self.passiveCaptcha,
              !STPAnalyticsClient.isUnitOrUITest || testTimeout != nil else {
