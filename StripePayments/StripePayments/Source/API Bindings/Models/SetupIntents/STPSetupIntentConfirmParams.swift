...
public class STPSetupIntentConfirmParams: NSObject, NSCopying, STPFormEncodable {
    ...
    @_spi(STP) public static func mandateDataIfRequired(for paymentMethodType: STPPaymentMethodType) -> STPMandateDataParams? {
        ...
        case .momo, .gcash, .ngCard, .touchNGo, .trueMoney, .goPay, .AUBECSDebit, .alipay, .bacsDebit, .bancontact, .iDEAL, .SEPADebit, .EPS, .link, .USBankAccount,
             .cashApp, .payPal, .revolutPay, .klarna, .amazonPay, .twint, .kakaoPay, .krCard, .naverPay:
