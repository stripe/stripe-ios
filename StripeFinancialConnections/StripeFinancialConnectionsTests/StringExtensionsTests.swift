...
class StringExtensionsTests: XCTestCase {
    ...
    func testExtractingLinksFromString() throws {
        ...
        XCTAssert(
            ...
            ==
            ("One Link", [String.Link(range: NSRange(location: 0, length: 8), urlString: "https://www.stripe.com/terms")])
        )
        XCTAssert(
            ...
            ==
            ("Complex Link", [String.Link(range: NSRange(location: 0, length: 12), urlString: "https://stripe.com/docs/api/financial_connections/ownership/object#financial_connections_ownership_object-id")])
        )
        XCTAssert(
