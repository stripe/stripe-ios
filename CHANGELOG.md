...
This release was removed due to a bug in PaymentSheet where payments could not be made for SEPA Debit.  This also affected Paypal when used with PaymentIntents+setup_future_usage or SetupIntents.
