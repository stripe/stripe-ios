...
* [Changed] `appearance.cornerRadius` is now nullable. When `nil`, the corner radius is 6.0 pre-iOS 26 (ie unchanged from the current default). On iOS 26+, multiple rounder corner configurations are used to match Liquid Glass design.
