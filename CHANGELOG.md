## X.Y.Z 2023-XX-YY
### PaymentSheet
* [Added] Enable bancontact for SetupIntents and PaymentIntents with setup_future_usage. Note: PaymentSheet doesn't display saved SEPA Debit payment methods yet.
