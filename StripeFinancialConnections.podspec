Pod::Spec.new do |s|
    ...
    s.ios.resource_bundle            = { 'StripeFinancialConnectionsBundle' => ['StripeFinancialConnections/StripeFinancialConnections/Resources/**/*.{lproj,png}', 'StripeCore/StripeCore/PrivacyInfo.xcprivacy'] }
end