Pod::Spec.new do |s|
    ...
    s.ios.resource_bundle            = { 'StripeFinancialConnections' => ['StripeFinancialConnections/StripeFinancialConnections/Resources/**/*.{lproj,png}', 'StripeFinancialConnections/StripeFinancialConnections/PrivacyInfo.xcprivacy'] }
end