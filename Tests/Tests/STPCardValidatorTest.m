...
- (void)testNumberSanitization {
    NSArray *tests = @[@[@"4242424242424242", @"4242424242424242"], @[@"XXXXXX", @""], @[@"424242424242424X", @"424242424242424"], ];
...
- (void)testNumberValidation {
    ...
    NSArray *possibleCardNumbers = @[@"4242", @"5", @"3", @"", @"    ", @"6011", ];
...
- (void)testCardValidation {
    ...
    for (NSArray *test in tests) {
        ...
        card.cvc = test[3];
        STPCardValidationState state = [STPCardValidator validationStateForCard:card inCurrentYear:15 currentMonth:8];
