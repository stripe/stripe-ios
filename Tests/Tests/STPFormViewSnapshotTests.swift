...
//        recordMode = true
    ...
    func testSingleInput() {
        let input = STPInputTextField(formatter: STPInputTextFieldFormatter(), validator: STPInputTextFieldValidator())
    ...
    func testMultiSection() {
        ...
        let section1 = STPFormView.Section(rows:  rows1, title: "First Section", accessoryButton: nil)
        ...
        let section2 = STPFormView.Section(rows:  rows2, title: "Second Section", accessoryButton: nil)
