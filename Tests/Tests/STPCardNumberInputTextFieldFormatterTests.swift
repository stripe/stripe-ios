...
class STPCardNumberInputTextFieldFormatterTests: XCTestCase {
    ...
    func testAllowedInput() {
        ...
        XCTAssertTrue(formatter.isAllowedInput("4242 4242 4242 4242", to: "", at: NSMakeRange(0, 0)))
        ...
        XCTAssertFalse(formatter.isAllowedInput("4242.4242.4242.4242", to: "", at: NSMakeRange(0, 0)))
