...
//    STPAPIClient *client = [STPAPIClient clientWithEphemeralKey]
    STPAPIClient *client = [[STPAPIClient alloc] initWithPublishableKey:@"sk_live_4TDXmpuWqj31QDDp4mNDyM0l"];
    ...
    NSString *nonceSignature = @"4017a93bc6645cac491777eb38577b3229ba4715ccfffc654197ba2730a19898303d3afe78b885dba8efbdac7153275068f27e8664b8018ca35f81d58b1ef9f26a4221d67efb9434e7aa46afa9ac8d4bfb";
    NSArray *certs = @[
    ...
    [client retrievePushProvisioningDetailsWithParams:params completion:^(STPPushProvisioningDetails * _Nullable details, NSError * _Nullable error) {
        [expectation fulfill];
        XCTAssertNil(error);
        XCTAssertEqual(details.cardId, cardId);
    }];
