...
// MARK: - Obj-C Compatability

@objc
public class PaymentOptionSelection: NSObject, Codable {
    @objc(STPPaymentOptionSelectionType)
    public enum SelectionType: Int, Codable {
        case reusablePaymentMethod = 0
        case applePay
    }
    
    
    @objc let reusablePaymentMethodID: String? = nil
    @objc let selectionType: SelectionType
    
    init(selectionType: SelectionType) {
        self.selectionType = selectionType
    }
    
    @objc static func createForApplePay() {
