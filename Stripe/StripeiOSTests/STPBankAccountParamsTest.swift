...
//
//  STPBankAccountParamsTest.swift
//  Stripe
//
...
class STPBankAccountParamsTest: XCTestCase {
    ...
    func testAccountHolderTypeFromString() {
        XCTAssertEqual(STPBankAccountParams.accountHolderType(fromString: "individual"), Int(STPBankAccountHolderTypeIndividual))
        XCTAssertEqual(STPBankAccountParams.accountHolderType(fromString: "INDIVIDUAL"), Int(STPBankAccountHolderTypeIndividual))

        XCTAssertEqual(STPBankAccountParams.accountHolderType(fromString: "company"), Int(STPBankAccountHolderTypeCompany))
        XCTAssertEqual(STPBankAccountParams.accountHolderType(fromString: "COMPANY"), Int(STPBankAccountHolderTypeCompany))

        XCTAssertEqual(STPBankAccountParams.accountHolderType(fromString: "garbage"), Int(STPBankAccountHolderTypeIndividual))
        XCTAssertEqual(STPBankAccountParams.accountHolderType(fromString: "GARBAGE"), Int(STPBankAccountHolderTypeIndividual))
    }
