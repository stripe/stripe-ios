...
///   - error: The error returned from the response, or nil if none occurs. - seealso: StripeError.h for possible values.
typealias STPSourceProtocolCompletionBlock = (STPSourceProtocol?, Error?) -> Void
...
typealias STPIntentClientSecretCompletionBlock = (String?, Error?) -> Void