...
class STPSourceSEPADebitDetailsTest: XCTestCase {
    ...
    func testDescription() {
        let sepaDebitDetails = STPSourceSEPADebitDetails.decodedObject(fromAPIResponse: STPTestUtils.jsonNamed("SEPADebitSource")?["sepa_debit"])
    ...
    func testDecodedObjectFromAPIResponseRequiredFields() {
        ...
        XCTAssert(STPSourceSEPADebitDetails.decodedObject(fromAPIResponse: STPTestUtils.jsonNamed("SEPADebitSource")?["sepa_debit"]))
    }
    ...
    func testDecodedObjectFromAPIResponseMapping() {
        ...
        XCTAssertEqual(sepaDebitDetails?.allResponseFields, response)
    }
}
