...
//
//  STPPaymentMethodBillingDetailsTest.swift
//  StripeiOS Tests
//
...
class STPPaymentMethodBillingDetailsTest: XCTestCase {
    ...
    func testDecodedObjectFromAPIResponseRequiredFields() {
        ...
        XCTAssertNotNil(STPPaymentMethodBillingDetails.decodedObject(fromAPIResponse: STPTestUtils.jsonNamed(STPTestJSONPaymentMethodCard)?["billing_details"]))
    }
    ...
    func testDecodedObjectFromAPIResponseMapping() {
        ...
        XCTAssertNotNil(billingDetails?.address ?? 0)
    }
}