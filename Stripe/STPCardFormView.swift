    ...
    required init(numberField: STPCardNumberInputTextField,
        ...
        if #available(iOS 13.0, *) {
            if (STPCardScanner.cardScanningAvailable()) {
              ...
              scanButton.titleLabel?.font = fontMetrics.scaledFont(for: UIFont.systemFont(ofSize: 13, weight: .semibold))
    ...
    class BillingAddressSubForm: NSObject {
        ...
        required init(billingAddressCollection: PaymentSheet.BillingAddressCollectionLevel) {
            ...
            case .required:
                ...
                line1Field =  STPGenericInputTextField(placeholder: STPLocalizedString("Address line 1", "Address line 1 placeholder for billing address form."), textContentType: .streetAddressLine1, keyboardType: .numbersAndPunctuation)
                line2Field = STPGenericInputTextField(placeholder:STPLocalizedString("Address line 2 (optional)", "Address line 2 placeholder for billing address form."), textContentType: .streetAddressLine2, keyboardType: .numbersAndPunctuation, optional: true)
                ...
                title = STPLocalizedString("Billing address", "Billing address section title for card form entry.")
            }
