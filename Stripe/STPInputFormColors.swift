...
class STPInputFormColors: NSObject {
    ...
    static var disabledTextColor: UIColor {
        return UIColor.dynamic(light: UIColor(red: 60.0/255.0, green: 60.0/255.0, blue: 67.0/255.0, alpha: 0.6), dark: UIColor(red: 235.0/255.0, green: 235.0/255.0, blue: 245.0/255.0, alpha: 0.6))
    }
    ...
    static var disabledBackgroundColor: UIColor {
        return UIColor.dynamic(light: UIColor(red: 248.0/255.0, green: 248.0/255.0, blue: 248.0/255.0, alpha: 1), dark: UIColor(red: 116.0/255.0, green: 116.0/255.0, blue: 128.0/255.0, alpha: 0.18))
    }
