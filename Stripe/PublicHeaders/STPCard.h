...
/**
 ...
 - STPCardFundingTypeDebit: Debit card funding
 - STPCardFundingTypeCredit: Credit card funding
 - STPCardFundingTypePrepaid: Prepaid card funding
 - STPCardFundingTypeOther: An other or unknown type of funding source.
 */
