...
/**
 The type of the error represented by `STPPaymentIntentLastError`.
 
 Some STPPaymentIntentLastError properties are only populated for certain error types.
 */
