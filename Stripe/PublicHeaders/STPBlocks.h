...
@class STPToken, STPShippingMethod;
 ...
 */
typedef void (^STPShippingMethodsCompletionBlock)(NSError * __nullable shippingValidationError, NSArray<STPShippingMethod *>* __nonnull shippingMethods);
