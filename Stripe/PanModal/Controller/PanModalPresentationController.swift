...
private extension PanModalPresentationController {
     ...
     */
    func addPresentedView(in containerView: UIView) {
        ...
        let belowTopConstraint = presentedView.topAnchor.constraint(lessThanOrEqualTo: containerView.safeAreaLayoutGuide.topAnchor)
        belowTopConstraint.priority = .defaultLow
        // Without the following constraint, the view has ambiguous height
        let shortAsPossibleConstraint = presentedView.topAnchor.constraint(equalTo: containerView.safeAreaLayoutGuide.bottomAnchor)
        shortAsPossibleConstraint.priority = .defaultLow
