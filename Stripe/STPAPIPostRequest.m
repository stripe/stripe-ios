...
+ (void)startWithAPIClient:(STPAPIClient *)apiClient
    ...
    [[apiClient.urlSession dataTaskWithRequest:request
                             completionHandler:^(NSData *_Nullable body, __unused NSURLResponse *_Nullable response, NSError *_Nullable error) {
