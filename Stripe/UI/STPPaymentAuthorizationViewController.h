...
- (void)paymentAuthorizationViewController:(nonnull STPPaymentAuthorizationViewController *)paymentAuthorizationViewController didCreatePaymentResult:(nonnull STPPaymentResult *)result;
