...
class MockCustomerAdapter: CustomerAdapter {
    ...
    func setSelectedPaymentOption(paymentOption: StripeElements.CustomerPaymentOption?) async throws {
    }
    func fetchSelectedPaymentOption() async throws -> StripeElements.CustomerPaymentOption? {
        return nil
    }
