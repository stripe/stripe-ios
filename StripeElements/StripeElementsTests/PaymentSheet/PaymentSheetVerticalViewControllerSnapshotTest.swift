...
final class PaymentSheetVerticalViewControllerSnapshotTest: STPSnapshotTestCase {
    ...
    var mockConfirmResult: StripeElements.PaymentSheetResult = .canceled
}

extension PaymentSheetVerticalViewControllerSnapshotTest: PaymentSheetViewControllerDelegate {
    func paymentSheetViewControllerShouldConfirm(_ paymentSheetViewController: any StripeElements.PaymentSheetViewControllerProtocol, with paymentOption: StripeElements.PaymentOption, completion: @escaping (StripeElements.PaymentSheetResult, StripeCore.STPAnalyticsClient.DeferredIntentConfirmationType?) -> Void) {
        completion(mockConfirmResult, nil)
    }

    func paymentSheetViewControllerDidFinish(_ paymentSheetViewController: any StripeElements.PaymentSheetViewControllerProtocol, result: StripeElements.PaymentSheetResult) {

    }

    func paymentSheetViewControllerDidCancel(_ paymentSheetViewController: any StripeElements.PaymentSheetViewControllerProtocol) {
    }

    func paymentSheetViewControllerDidSelectPayWithLink(_ paymentSheetViewController: any StripeElements.PaymentSheetViewControllerProtocol) {
    }
}
