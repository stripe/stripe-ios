...
@testable @_spi(STP) @_spi(CustomerSessionBetaAccess) import StripeElements
...
extension PaymentSheet_LPM_ConfirmFlowTests: PaymentMethodFormViewControllerDelegate {
    nonisolated func didUpdate(_ viewController: StripeElements.PaymentMethodFormViewController) {
    }
...
extension IntentConfirmParams: Equatable {
    static public func == (lhs: StripeElements.IntentConfirmParams, rhs: StripeElements.IntentConfirmParams) -> Bool {
