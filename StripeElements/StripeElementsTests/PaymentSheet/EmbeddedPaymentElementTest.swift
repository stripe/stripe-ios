...
@_spi(EmbeddedPaymentElementPrivateBeta) @_spi(STP) @testable import StripeElements
...
extension EmbeddedPaymentElementTest: EmbeddedPaymentElementDelegate {
    ...
    func embeddedPaymentElementDidUpdatePaymentOption(embeddedPaymentElement: StripeElements.EmbeddedPaymentElement) {
...
extension EmbeddedPaymentElement.UpdateResult: Equatable {
    public static func == (lhs: StripeElements.EmbeddedPaymentElement.UpdateResult, rhs: StripeElements.EmbeddedPaymentElement.UpdateResult) -> Bool {
        switch (lhs, rhs) {
...
extension PaymentSheetResult: Equatable {
    public static func == (lhs: StripeElements.PaymentSheetResult, rhs: StripeElements.PaymentSheetResult) -> Bool {
        switch (lhs, rhs) {
