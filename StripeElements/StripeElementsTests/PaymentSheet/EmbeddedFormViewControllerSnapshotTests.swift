...
@_spi(STP)  @_spi(EmbeddedPaymentElementPrivateBeta) @testable import StripeElements
...
extension EmbeddedFormViewControllerSnapshotTests: EmbeddedFormViewControllerDelegate {
    func embeddedFormViewControllerShouldConfirm(_ embeddedFormViewController: StripeElements.EmbeddedFormViewController, with paymentOption: StripeElements.PaymentOption, completion: @escaping (StripeElements.PaymentSheetResult, StripeCore.STPAnalyticsClient.DeferredIntentConfirmationType?) -> Void) {
    }
    
    func embeddedFormViewControllerDidCompleteConfirmation(_ embeddedFormViewController: StripeElements.EmbeddedFormViewController, result: StripeElements.PaymentSheetResult) {
    }
    
    func embeddedFormViewControllerDidCancel(_ embeddedFormViewController: StripeElements.EmbeddedFormViewController) {
    }
    
    func embeddedFormViewControllerDidContinue(_ embeddedFormViewController: StripeElements.EmbeddedFormViewController) {
    }
}
