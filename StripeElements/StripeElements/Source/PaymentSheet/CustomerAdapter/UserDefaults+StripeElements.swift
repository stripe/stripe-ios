...
extension UserDefaults {
    ...
    @_spi(STP) public enum StripeElementsKeys: String {
    ...
    @_spi(STP) public var customerToLastSelectedPaymentMethod: [String: String]? {
        get {
            let key = StripeElementsKeys.customerToLastSelectedPaymentMethod.rawValue
    ...
    @_spi(STP) public var customerHasUsedLink: Bool {
        get {
            let key = StripeElementsKeys.customerHasUsedLink.rawValue
