...
//
// NOTE: This file is copied over from StripeCore. Will remove once ported to `stripe-ios`.
...
@_spi(STP) public final class STPLocalizationUtils {
    ...
    static func localizedStripeStringUseMainBundle(bundleLocator: BundleLocatorProtocol.Type) -> Bool {
    ...
    public class func localizedStripeString(forKey key: String, bundleLocator: BundleLocatorProtocol.Type) -> String {
