Pod::Spec.new do |s|
  ...
  s.ios.resource_bundle            = { 'StripePaymentSheetBundle' => ['StripePaymentSheet/StripePaymentSheet/Resources/**/*.{lproj,png,xcassets,json}', 'StripeCore/StripeCore/PrivacyInfo.xcprivacy'] }
